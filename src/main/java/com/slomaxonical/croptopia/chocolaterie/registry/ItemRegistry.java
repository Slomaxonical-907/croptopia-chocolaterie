...
//    public static Item pressedCocoaCone = new Item(CroptopiaChocolaterie.createGroup());
    ...
    public static final Item DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item CARAMEL_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item PRALINE_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item STRAWBERRY_CREAM_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item COOKIE_CREAM_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item MIXED_NUTS_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item COCONUT_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item PEANUT_BUTTER_DARK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));

    public static final Item MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item CARAMEL_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item PRALINE_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item STRAWBERRY_CREAM_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item COOKIE_CREAM_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item MIXED_NUTS_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item COCONUT_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item PEANUT_BUTTER_MILK_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));

    public static final Item WHITE_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item CARAMEL_WHITE_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item PRALINE_WHITE_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item STRAWBERRY_CREAM_WHITE_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item COOKIE_CREAM_WHITE_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
    public static final Item MIXED_NUTS_WHITE_CHOCOLATE = new Item(createGroup().food(EDIBLE_7));
...
//        registerItem("pressed_cocoa_cone",pressedCocoaCone);
        ...
        registerItem("dark_chocolate_dipped_apple", DARK_CHOCOLATE_DIPPED_APPLE);
        registerItem("milk_chocolate_dipped_apple", MILK_CHOCOLATE_DIPPED_APPLE);
        registerItem("white_chocolate_dipped_apple", WHITE_CHOCOLATE_DIPPED_APPLE);
    }
